...
public class SendAccountFormIntentHandler implements RequestHandler {
	...
	public boolean canHandle(HandlerInput input) {
		return input.matches(intentName("SendAccountFormIntent"));
	}
	...
	public Optional<Response> handle(HandlerInput input) {
		...
		if (email != null && !email.isEmpty()) {
			...
			String accountName = db1.accountNameById(accountId);
			if (accountId != 0) {
				BaseMethods b=new BaseMethods();
		        b.sendMail(finalEmail,accountName);
